...
async def hi(event):
    await edit_or_reply(
        event,
        "اوامـر جلب ة وامر الاضافة**:\n\n ⟸ `.ضيف`\n❖ اكتب الامر مع رابط مجموعه التي تريد سحب اعضائها وارسل الامر في مجموعتك لسحبهم الى مجموعتك\n\n ⟸`.جلب الذاتيه`  او  `.ذاتية`\n❖     ذاتية التدمير لحفظها وارسالها في الرسائل المحفوظة بسرية تامة الامر لادثون حصريا!",
    )
